...
- `output.min_matched_prefix_length` and `output.min_matched_suffix_length` let you keep the broader search active while only saving stronger keep-running hits such as `5x5+`
